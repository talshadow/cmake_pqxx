...
#		message(STATUS "check unbroken iterator " )
		...
		set(${result}_test ON CACHE INTERNAL BOOL)
#		message(STATUS "unbroken interator is ${${result}}")
	endif(NOT ${result}_test)
...
function(scope_headers _inDir _outHeaders)
  foreach(_inExt *.h *.hpp *.hxx )
	file(GLOB tmpoutHeaders ${_inDir}/${_inExt})
	set(outHeaders ${outHeaders} ${tmpoutHeaders})
  endforeach(_inExt "*.h;*.hpp;*.hxx")
  file(GLOB _tmpFiles ${_inDir}/*)
  file(GLOB _tmpFiles2 ${_inDir}/*.*)
  list(REMOVE_ITEM _tmpFiles ${_tmpFiles2})
  set(${_outHeaders} ${_tmpFiles};${outHeaders} CACHE INTERNAL LIST )
endfunction(scope_headers _inDir _outHeaders)
